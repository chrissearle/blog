...
Just in case the post is unavailable in future - here's a :download{title="local copy of the script" path="/files/posts/2020/01/reset-dns.sh"} - just remember to replace the VPN name with your VPN name.
