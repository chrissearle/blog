...
tags: [sky-watcher, star adventurer, nikon, dr-5, right-angle finder, astrophotography]
...
Second attempt after looking through a fair number of options out there was to model in Fusion 360. After a few attempts I ended up with the following model (:download{title="STL file" path="/files/posts/2019/04/nikon-star-adventurer.stl"})):
